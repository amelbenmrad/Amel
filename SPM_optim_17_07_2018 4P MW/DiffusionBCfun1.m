...
function [pl, ql, pr, qr] = DiffusionBCfun1(xl, ul, xr, ur, t, P,kp_ref,D01,C1_star,C2_star)
...
%     P.D_2=P.D02*exp(-(P.w1*P.V1_star*P.xi_23/P.xi_13+P.w2*P.V2_star+P.w3*P.V3_star*P.xi_23)/(P.w1*P.K11_div_g*(P.K21_m_Tg+T)+P.w2*P.K12_div_g*(P.K22_m_Tg+T)+P.w3*P.K13_div_g*(P.K23_m_Tg+T)));
    ...
    %% %%%%% PDE COEFFICIENT %%%%%
    %    [M1;                 M2,                   T                   r_pol   nu0     nu1     nu2     C3]
    pl = [0;                  0;                    0;                   0;     0;      0;      0;      0];
    ql = [1 / D_1;            1 / P.D_2;            1 / P.kc_ov;         1;     1;      1;      1;      1];
    pr = [ur(1) - P.C1_eq;    ur(2) - P.C2_eq;      h * (ur(3) - P.Tb);  0;     0;      0;      0;      0];
    qr = [0;                  0;                    1;                   1;     1;      1;      1;      1];
